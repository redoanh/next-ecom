...
import ImporChildTable from "@/app/(withlayout)/super_admin/import_5C4/components/importChildTable";
...
import ExportChildTable from "../components/ExportChildTable";
...
const CreateAdminPage = () => {
  ...
  return (
    ...
    >
      <UMBreadCrumb pageName="Export" lastName="Create" />
      <div
        style={{
          padding: "20px 0px",
          marginTop: "0px",
                  ...
                  />
                    ...
                    >
                      <FormInput
                        ...
                        name="admin.name.firstName"
                        size="large"
                        label="Total Amount In Transaction:"
                        required
                        disable
                      />
                    </Col>
